...
final List<User> appUsers = [
    User(
      ...
      location: 'Aveiro',
      profileImage: AppImage.asset('assets/images/users/emma.jpg'),
      rating: '4.5',
    ...
    User(
      ...
      location: 'Aveiro', 
      profileImage: AppImage.asset('assets/images/users/joana.jpeg'), 
      rating: '4.2', 
    ...
    User(
      ...
      location: 'Aveiro', 
      profileImage: AppImage.asset('assets/images/users/manuel.jpeg'), 
      rating: '4.0', 
      favGenres: ['Romance', 'Poesia'], 
    ...
    User(
      ...
      email: 'ana@email.com', 
      location: 'Aveiro', 
      profileImage: AppImage.asset('assets/images/users/ana.jpeg'), 
      rating: '3.9', 
    ...
    User(
      ...
      location: 'Aveiro', 
      profileImage: AppImage.asset('assets/images/users/maria.jpeg'), 
      rating: '3.5', 
    ...
    User(
      ...
      location: 'Aveiro', 
      profileImage: AppImage.asset('assets/images/users/pedro.jpeg'), 
      rating: '4.1', 
      favGenres: ['Ficção'], 
    ...
    User(
      ...
      location: 'Aveiro', 
      profileImage: AppImage.asset('assets/images/users/galileu.jpg'), 
      rating: '4.2', 
