...
class _PostScreenState extends State<PostScreen> {
  ...
  // Detalhes do livro específico para o ISBN 9788186734896
  ...
  void goToNextScreen() {
    setState(() {
      if (_isbnConfirmationScreen) {
        ...
        if (_isbnController.text == '9788186734896') {
        ...
        _currentScreen = 3; // localização
      } else if (_currentScreen == 3) {
        _currentScreen = 4; // fotos
        ...
        _selectedImages.clear(); // limpa as fotos também
        _currentScreen = 0;
      }
    });
  }
  ...
  void goBack() {
    setState(() {
      // falta implementar para o ecrã 4 mas primeiro verificar se dá pra abrir a camera e galeria
      if (_isbnConfirmationScreen) {
        _isbnConfirmationScreen = false;
      } else if (_currentScreen == 3) {
        // Localização/Notas, volta para detalhes
        _currentScreen = 2;
      } else if (_currentScreen == 2) {
        if (selectedOption == 'isbn') {
          // Vai para a tela de ISBN
          _currentScreen = 1;
        } else {
        ...
        // De volta para a tela de seleção de método
        _currentScreen = 0;
      }
    });
  }

  // Widget para botão padronizado
  ...
  Widget _buildNavigationButtons() {
    ...
    String leftButtonText =
        _isbnConfirmationScreen ? 'Editar' : 'Anterior'; // <-- Aqui
  ...
  // Método para construir a tela de seleção de método de postagem
  ...
  // Método para construir a tela de ISBN
  ...
  // Método para construir a tela de confirmação de ISBN
